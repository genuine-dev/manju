...
public class ArticleRegisteredEvent {
	...
	private final RegisteredDateTime registeredDateTime;

	private final ModifiedDateTime modifiedDateTime;

	public ArticleRegisteredEvent(ArticleId id, Author author, Title title, Body body, Tags tags,
			PublicationTargets publicationTargets, Status status, PublishedDateTime publishedDateTime,
			RegisteredDateTime registeredDateTime, ModifiedDateTime modifiedDateTime) {
		this.id = id;
		this.author = author;
		this.title = title;
		this.body = body;
